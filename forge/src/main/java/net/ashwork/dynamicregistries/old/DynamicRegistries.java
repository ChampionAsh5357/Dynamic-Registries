...
import net.ashwork.dynamicregistries.old.mixin.NetworkFilterAccess;
import net.ashwork.dynamicregistries.old.network.DynamicRegistryNetworkFilter;
import net.ashwork.dynamicregistries.old.network.DynamicRegistryPacket;
import net.ashwork.dynamicregistries.old.registry.DynamicRegistry;
import net.ashwork.dynamicregistries.old.registry.IRegistrableDynamicRegistry;
